const Footer = () => {
    return (
        <div className="bg-slate-900">
            <div className="mx-auto container grid grid-cols-4 px-16 pt-12 pb-16">
                ...
                <div className="flex flex-col items-start space-y-6">
                    ...
                    <a href="https://www.pixeltrue.com/free-packs/lined-illustrations" target="_blank" className="text-sm font-medium text-slate-400">Illustrations</a>
                    <a href="https://heroicons.com/" target="_blank" className="text-sm font-medium text-slate-400">Icons</a>
                </div>
                <div className="flex flex-col items-start space-y-6">
                    <p className="text-sm font-medium text-white leading-8 pb-2">Source files</p>
                    <a href="#" className="text-sm font-medium text-slate-400">Github</a>
                </div>
            </div>
        </div>
    );
