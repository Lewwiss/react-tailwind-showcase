const Features = () => {
    return (
        <div className="mx-auto container py-10">
            ...
            <h2 className="font-bold text-5xl text-slate-800 text-center">See what you can do</h2>
            <div className="mx-auto max-w-6xl grid grid-cols-2 pt-16">
                <div className="flex items-center justify-center">
                    <img src="/images/2.svg" width={400} />
                </div>
                <div className="flex flex-col items-start justify-center p-16">
                    <h1 className="font-bold text-4xl text-slate-800 leading-tight">Share files at the<br />same time</h1>
